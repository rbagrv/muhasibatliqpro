                    ...
                    <tbody>
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td><span class="change positive"><strong>+3.5%</strong></span></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="change negative"><strong>-1.76%</strong></span></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="change positive"><strong>+8.75%</strong></span></td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-input" value="${data.name || 'Balans Hesabatı'}" required ${isView ? 'readonly' : ''}>
                            </div>
                            <div class="form-group">
